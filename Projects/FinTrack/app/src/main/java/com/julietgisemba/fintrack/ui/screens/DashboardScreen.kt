...
fun DashboardScreen() {
    ...
    val transactions = listOf(
        Transaction("Groceries", "Aug 18", "Food", Icons.Default.ShoppingCart, -54.20, isIncome = false),
        Transaction("Salary", "Aug 15", "Income", Icons.Default.DateRange, 2800.00, isIncome = true),
        Transaction("Transport", "Aug 14", "Commute", Icons.Default.ThumbUp, -18.60, isIncome = false)
    )

    val budgets = listOf(
        Budget("Food & Dining", spent = 320.0, limit = 500.0, Icons.Default.DateRange),
        Budget("Housing", spent = 900.0, limit = 1200.0, Icons.Default.DateRange),
        Budget("Transport", spent = 110.0, limit = 200.0, Icons.Default.DateRange)
    )
